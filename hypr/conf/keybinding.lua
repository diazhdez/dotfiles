...
-- Apps
hl.bind(mainMod .. " + Backspace", hl.dsp.exec_cmd("ghostty"))
...
hl.bind(mainMod .. " + W", hl.dsp.exec_cmd("~/.config/scripts/wallpaper_select.sh"))
hl.bind(mainMod .. " + P", hl.dsp.exec_cmd("~/.config/scripts/app_launcher.sh"))
hl.bind(mainMod .. " + Z", hl.dsp.exec_cmd("~/.config/scripts/wifi_menu.sh"))
